...
$query = "SELECT clients.names, cases.case_title,cases.day,cases.month,cases.year,cases.time,cases.id FROM clients,cases WHERE `cases`.`status`='pending' AND clients.id=cases.client_id AND cases.lawyer_id='$id'  ";
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">New Cases</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
