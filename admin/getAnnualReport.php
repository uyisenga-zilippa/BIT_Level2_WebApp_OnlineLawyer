...
//$month=$_POST['month'];
$year = $_POST['year'];
$query = "SELECT lawyers.names,payment.day,payment.month,payment.year, payment.amount,clients.names,payment.reason FROM lawyers,payment,clients WHERE lawyers.id=payment.receiver_id AND payment.payer_id=clients.id AND payment.status='sent' AND payment.year='$year'";
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            All Lawyers and Amount Paid In <?php echo $year ?> Year
                        </div>
                        <!-- /.panel-heading -->
                        <div class="col-lg-12">
